    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">沿線マスタ</li>
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        <li class="breadcrumb-item active" aria-current="page">鉄道沿線マスタ</li>
                    </ol>
                </nav>
            </div>
            {{-- <div class="ms-auto">
        ...
        <div class="row">
            <div class="col-xl-9 mx-auto">
                <h6 class="mb-0 text-uppercase">鉄道沿線csv管理</h6>
                <hr />
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <h5 class="card-title">鉄道沿線マスタCSVアップロード</h5>
                        </div>
                        <form method="post" action="{{ route('importLineCSV') }}" class="" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            <div class="mb-3">
                                <label for="formFile" class="form-label"><a href="https://www.ekidata.jp/">駅データ.jp</a> よりダウンロードしたline.csvをそのままアップロード可能です</label>
                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            <ul>
                                ...
                                <li>駅データ.jp よりダウンロードしたline.csvをそのままアップロード可能です。</li>
                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">沿線名</th>
                                    <td>line_name</td>
                                    <td><span class="text-danger">※必須項目</span><br>沿線名を入力</td>
                                    <td>文字(40)</td>
                                    <td>40文字以内で沿線名を入力</td>
                                </tr>
                                <tr>
                    ...
                    <div class="card-footer">
                        <form method="get" action="{{ route('exportLineCSV') }}" enctype="multipart/form-data">
                            @csrf
                            @method('get')
