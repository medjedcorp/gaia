...
<div class="page-wrapper">
	<div class="page-content">
			...
			<div class="ps-3">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0 p-0">
						...
						<li class="breadcrumb-item"><a href="{{ url('railroad') }}">Lines</a></li>
		...
		<!--end breadcrumb-->
		<h6 class="mb-0 text-uppercase"><i class="fadeIn animated bx bx-train mr-1"></i> {{$line_name->line_name}} {{$st_name->station_name}}駅 の売土地一覧</h6>
		<hr />
		<div class="card">
			<div class="card-body">
