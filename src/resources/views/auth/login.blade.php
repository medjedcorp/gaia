                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="text-center">
                                        <h3 class="">ログイン</h3>
                                        <p>アカウントがない場合 <a href="{{ url('register') }}">こちらよりお問い合わせ</a>
                                        </p>
                                    </div>
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="col-12">
                                                <label for="inputChoosePassword" class="form-label">パスワードを入力</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="flexSwitchCheckChecked" name="remember">ログイン情報を記憶</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 text-end"> <a href="{{ url('authentication-forgot-password') }}">パスワードを忘れた場合</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>ログイン</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
