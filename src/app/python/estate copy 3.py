...
try:
    ...
    while True:
        ...
        for i in range(detail_count):
            ...
            print(property_num.text + '：物件取込開始')
            ...
            # find_elementsで全部取得して、要素の回数分回すようにする
            # base = driver.find_element(By.CLASS_NAME, "row-image")
            # targets = driver.find_elements(locate_with(By.CLASS_NAME, "mx-auto").above(base))
            ...
            if len(driver.find_elements(by=By.XPATH, value=photos[0])) > 0 :
                ...
                start_time = time.perf_counter()
                if driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[10]/div[2]/div/div[2]/div") :
                ...
                elif driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[9]/div[1]/div/a/div") :
                ...
                elif driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[8]/div[2]/div/div[2]/div") :
                ...
                elif driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[7]/div[2]/div/div[2]/div") :
                ...
                elif driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[6]/div[2]/div/div[2]/div") :
                ...
                elif driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[5]/div[2]/div/div[2]/div") :
                ...
                elif driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[4]/div[2]/div/div[2]/div") :
                ...
                elif driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[3]/div[2]/div/div[2]/div") :
                ...
                elif driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[2]/div[2]/div/div[2]/div") :
                ...
                elif driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[20]/div/div/div[1]/div[2]/div/div[2]/div") :
                ...
                end_time = time.perf_counter()
                elapsed_time = end_time - start_time
                print('物件画像はありませんでした。：' + str(elapsed_time) + '秒')
            ...
            if len(driver.find_elements(by=By.XPATH, value="//*[@id='__layout']/div/div[1]/div[1]/div/div[21]/div/div/div/div[2]/div[1]")) > 0 :
                ...
                for j in range(5):
                    if pdf_flag:
                        ...
                        print('ボタンをクリックします')
                        zumen_btn.click()
                        # actionChains.double_click(zumen_btn).perform()
